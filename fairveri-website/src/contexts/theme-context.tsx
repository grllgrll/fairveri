...
export function ThemeToggle() {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 hidden group-hover:block">
        <div className="p-2">
          <button
...
// Simple theme toggle button for navigation
